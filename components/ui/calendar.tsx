  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: "text-sm font-medium px-3 py-2 rounded-md border border-input bg-background hover:bg-accent hover:text-accent-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 appearance-none cursor-pointer",
